DROP FUNCTION IF EXISTS public.update_settings_authenticated(text, boolean, text, text, text, boolean, boolean, boolean, integer, text, text, text, text, boolean, boolean, text, integer);
DROP FUNCTION IF EXISTS public.update_settings_authenticated(text, boolean, text, text, text, boolean, boolean, boolean, integer, text, text, text, text, boolean, integer, boolean, text, integer);
