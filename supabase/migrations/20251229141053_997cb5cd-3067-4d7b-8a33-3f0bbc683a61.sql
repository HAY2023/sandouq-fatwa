-- Drop all conflicting versions of update_settings_authenticated
DROP FUNCTION IF EXISTS public.update_settings_authenticated(text, boolean, timestamp with time zone, text, text);
DROP FUNCTION IF EXISTS public.update_settings_authenticated(text, boolean, timestamp with time zone, text, text, boolean);
DROP FUNCTION IF EXISTS public.update_settings_authenticated(text, boolean, timestamp with time zone, text, text, boolean, boolean);
